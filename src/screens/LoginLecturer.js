...
const LoginStudent = ({navigation}) => {
    ...
    const [passwordL, setPaswordL] =useState('');
    return (
    /*Background*/
    <ImageBackground 
        source={image} 
        ...
        <View style={{ 
            ...
            {/*Text Welcome Students and Enter email-password*/}
            <View style={{marginHorizontal: 30, marginTop:20}}>
                <Text style={{color: '#ffffff', fontSize: 36}}>Welcome Lecturer :)</Text>
                <Text style={{color: '#ffffff', fontSize: 20}}>Please enter your email number and password!</Text>
            </View>
            ...
            {/*Button Login*/}
            <TouchableOpacity 
                onPress={() => navigation.navigate('MainScreenLecturer')}
            ...
            <View style={{marginTop:2, flexDirection: 'row'}}>
                <TouchableOpacity onPress={() => navigation.navigate('SignUpLecturer')}>
                    <Text style={{
                            marginTop:10,
                            marginRight: 140,
                            fontSize: 15,
