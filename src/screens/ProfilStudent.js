    ...
    return (
        ...
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Text style={{
                color: '#ffffff',
                fontSize: 25,
                fontWeight:'bold'}}>Jeremy A, Pongantung</Text>
            ...
            <Text style={{
                paddingTop: 20,
                color: '#ffffff',
                fontSize: 15,}}>Registration number:</Text>
            <Text style={{
                color: '#ffffff',
                fontSize: 25,
                fontWeight:'bold'}}>S21710466</Text>
            ...
            <Text style={{
                paddingTop: 20,
                color: '#ffffff',
                fontSize: 15,}}>Study program:</Text>  
            <Text style={{
                color: '#ffffff',
                fontSize: 25,
                fontWeight:'bold'}}>Informatics</Text>
            </View>
